...
/**
 * Returns all game IDs in the stable order used for static routes.
 *
 * @param db Injectable database client used for the query.
...
/**
 * Returns all categories in deterministic display order.
 *
 * @param db Injectable database client used for the query.
...
/**
 * Returns all publishers in deterministic display order.
 *
 * @param db Injectable database client used for the query.
